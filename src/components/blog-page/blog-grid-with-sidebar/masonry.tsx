...
const Masonry = () => {
  return (
    <>{ /* Blog Masonry Grid with Sidebar (from blog-grid-with-sidebar-light.html) */ }
                      ...
                      <div className="col-xl-6 col-lg-12 col-md-6">
                         <div className="cs-blog-item mb-70">
                            <div className="cs-blog-thumb fix p-relative mb-25">
                               <img className="w-100" src="assets/img/blog/standard-grid/thumb.jpg" alt="" />
                               <a href="#" className="cs-blog-tag">Branding</a>
                            </div>
                            <h4 className="cs-blog-title tp-ff-sequel-semi-bold"><a href="blog-details-light.html" className="common-underline">Your marketplace dreams <br /> we shape them.</a></h4>
                         </div>
                      </div>
                      <div className="col-xl-6 col-lg-12 col-md-6">
                         <div className="cs-blog-item mb-70">
                            <div className="cs-blog-thumb fix p-relative mb-25">
                               <img className="w-100" src="assets/img/blog/standard-grid/thumb-2.jpg" alt="" />
                               <a href="#" className="cs-blog-tag">Web Design</a>
                            </div>
                            <h4 className="cs-blog-title tp-ff-sequel-semi-bold"><a href="blog-details-light.html" className="common-underline">Where design meets your platform becomes.</a></h4>
                         </div>
                      </div>
                      <div className="col-xl-6 col-lg-12 col-md-6">
                         <div className="cs-blog-item mb-70">
                            <div className="cs-blog-thumb fix p-relative mb-25">
                               <img className="w-100" src="assets/img/blog/standard-grid/thumb-3.jpg" alt="" />
                               <a href="#" className="cs-blog-tag">Development</a>
                            </div>
                            <h4 className="cs-blog-title tp-ff-sequel-semi-bold"><a href="blog-details-light.html" className="common-underline">This isn&rsquo;t just design design makes reimagined.</a></h4>
                         </div>
                      </div>
                      <div className="col-xl-6 col-lg-12 col-md-6">
                         <div className="cs-blog-item mb-70">
                            <div className="cs-blog-thumb fix p-relative mb-25">
                               <img className="w-100" src="assets/img/blog/standard-grid/thumb-4.jpg" alt="" />
                               <a href="#" className="cs-blog-tag">Branding</a>
                            </div>
                            <h4 className="cs-blog-title tp-ff-sequel-semi-bold"><a href="blog-details-light.html" className="common-underline">We design solutions that<br /> shape futures</a></h4>
                         </div>
                      </div>
                      <div className="col-xl-6 col-lg-12 col-md-6">
                         <div className="cs-blog-item mb-70">
                            <div className="cs-blog-thumb fix p-relative mb-25">
                               <img className="w-100" src="assets/img/blog/standard-grid/thumb-5.jpg" alt="" />
                               <a href="#" className="cs-blog-tag">Web Design</a>
                            </div>
                            <h4 className="cs-blog-title tp-ff-sequel-semi-bold"><a href="blog-details-light.html" className="common-underline">Turning bold ideas into<br /> digital reality</a></h4>
                         </div>
                      </div>
                      <div className="col-xl-6 col-lg-12 col-md-6">
                         <div className="cs-blog-item mb-70">
                            <div className="cs-blog-thumb fix p-relative mb-25">
                               <img className="w-100" src="assets/img/blog/standard-grid/thumb-6.jpg" alt="" />
                               <a href="#" className="cs-blog-tag">Development</a>
                            </div>
                            <h4 className="cs-blog-title tp-ff-sequel-semi-bold"><a href="blog-details-light.html" className="common-underline">Transforming marketplace<br /> into lasting success</a></h4>
                         </div>
                      </div>
                      <div className="col-xl-6 col-lg-12 col-md-6">
                         <div className="cs-blog-item mb-70">
                            <div className="cs-blog-thumb fix p-relative mb-25">
                               <img className="w-100" src="assets/img/blog/standard-grid/thumb-7.jpg" alt="" />
                               <a href="#" className="cs-blog-tag">Web Design</a>
                            </div>
                            <h4 className="cs-blog-title tp-ff-sequel-semi-bold"><a href="blog-details-light.html" className="common-underline">From your dreams, we<br /> create impact</a></h4>
                         </div>
                      </div>
                      <div className="col-xl-6 col-lg-12 col-md-6">
                         <div className="cs-blog-item mb-70">
                            <div className="cs-blog-thumb fix p-relative mb-25">
                               <img className="w-100" src="assets/img/blog/standard-grid/thumb-8.jpg" alt="" />
                               <a href="#" className="cs-blog-tag">Development</a>
                            </div>
                            <h4 className="cs-blog-title tp-ff-sequel-semi-bold"><a href="blog-details-light.html" className="common-underline">We design solutions that<br /> shape futures</a></h4>
                         </div>
